...
from brax.training.agents.opac import utils
...
def make_inference_fn(sac_networks: SACNetworks):
  ...
  def make_policy(params: types.PolicyParams, deterministic: bool = False) -> types.Policy:
    ...
    def policy(observations: types.Observation,
      ...
      no_postprocessor_action = sac_networks.parametric_action_distribution.sample_no_postprocessing(logits, key_sample)
      return sac_networks.parametric_action_distribution.postprocess(no_postprocessor_action), {
            "non_tanh_action": no_postprocessor_action}
